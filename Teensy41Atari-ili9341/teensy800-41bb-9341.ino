...
// Use Electrodragon ITI9431 2.4" 320x240 Display
/////////////////////////////////////////////////////////////////////////////////////////////
// ILI9341 Display  Teensy 4.1
// Pin 1 Vcc ------ Vin5v  
// Pin 2 Gnd ------ Gnd  
// Pin 3 CS  ------ Pin 22
// Pin 4 RST ------ Pin 23 
...
// Pin 7 SCK ------ Pin 13 
// Pin 8 LED ------ 3v3    
// Pin 9 Miso------ No connection
//
// Sound is working SOUND 2,100,10,10
// Not necessary to change pins_arduino.h in teensy4 folder, PIN_SPI_SS leave it at (10) 
// Sound still working if display's MISO connected to Teensy 4.1 pin 12
// Sound still working if display's SDCS connected to Teensy 4.1 pin 8 (no SDcard in display)
////////////////////////////////////////////////////////////////////////////////////////////
