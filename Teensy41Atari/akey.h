...
const unsigned short usbkey2ScanCode[] = {  
  ...
  //         F1   AtariXL   F4, HLP, Strt Sel  Opt  Rst  INV,                     // ATARI AKEY_ATARI 0x27 = INVERSE key 39 
  ...
  //   INS            DEL,           RGT, LFT, DWN,  UP,                          // ATARI  
  255, 183, 255, 255, 180, 255, 255, 135, 134, 143, 142, 255, 255, 255, 255, 255};// AKEY_RIGHT 0x87 AKEY_LEFT 0x86 AKEY_DOWN 0x8f AKEY_UP 0x8e 
