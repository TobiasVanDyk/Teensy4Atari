...
extern int usbF6;         // 63 key199
extern int usbF7;         // 64 key200
extern int usbF8;         // 65 key201
extern int usbF9;         // 66 key202
...
// 2. Then input from keyboard or buttons
///////////////////////////////////////////////////////
void loop(void) 
{
  // 1. ///////////////////////////////////////////////
...
{ Serial.print("raw key press: ");
  ...
  if (keycode==57) { if (usbcapslock==64)  usbcapslock = 0; else usbcapslock = 64; }     // Toggle 64 or 0 CAPSLOCK 60 3C 0011 1100
