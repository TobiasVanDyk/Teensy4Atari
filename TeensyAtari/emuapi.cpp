...
//#define MENU_FILE_BGCOLOR   RGBVAL16(0x89,0xAB,0xFF)           // allmost black-blue
#define MENU_FILE_BGCOLOR   RGBVAL16(0x00,0x00,0x90)           // dark blue
#define MENU_FILE_CGCOLOR   RGBVAL16(0xE0,0xEF,0xFF)           // white blue
#define MENU_FILE_FGCOLOR   RGBVAL16(0xE0,0xEF,0xFF)           // white blue
...
#endif
//if (j2>0) Serial.println(j2,HEX); // shows 20, 40 or 80 or do a reset as below
//if (j1>0) Serial.println(j1,HEX); // shows 20, 40 or 80 or do a reset as below
