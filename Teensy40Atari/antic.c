...
UWORD Screen_atari[ATARI_WIDTH / 2];       // sizeof(Screen_atari=384/2=192 = NULL 
#define scrn_line 0                        //(ATARI_WIDTH / 2)

/////////////////////////////////////////////////////////////////////////////////////////////////////////
// height y=9 to y=247
//  emu_DrawLine(unsigned char * VBuf, int width, int height, int line);
//        tft.writeLine(width,     1,          line,  VBuf,         palette16);
// TFT_T_DMA::writeLine(int width, int height, int y, uint8_t *buf, uint16_t *palette16)
/////////////////////////////////////////////////////////////////////////////////////////////////////////
#define DRAWLINE() \
...
#define LCHOP 3			// no leftmost 0..3 characters in wide mode 4x8=32
#define RCHOP 3			// no rightmost 0..3 characters in wide mode 
...
////////////////////////////////////////////////////////////////////////////
// Video memory access is hidden behind these macros
// It allows to track dirty video memory to improve video system performance 
#ifdef DIRTYRECT
////////////////////////////////////////////////////////////////////////////
