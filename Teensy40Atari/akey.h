...
// Scancode > 63 here implies either b6 shift > 127 or b7 control pressed 
// NB KBCODE b7 b6 are set here according to the code obtained (reverse of what HW does)
// KBCODE = 53769 $D209 
/////////////////////////////////////////////////////////////////////////////////////////////////////
const unsigned short usbkey2ScanCode[] = {  
  ...
  // Ctrl-A=1,Crtl-S=19,Ctrl-Q=17,Ctrl-Z=26
  ...
  // ,   !,   ',   #,   $,   %,   &,   &,   *,   (,   *,   +,   ,,   -,   +,   /, // ATARI 
   33,  95,  94,  90,  88,  93,  91, 115, 112, 114,   7,   6,  32,  14,  34,  38, //
  ...
  //         F1---AtariXL---F4, HLP, Strt Sel  Opt  Rst  INV, BRK,                // ATARI AKEY_ATARI 0x27 = INVERSE key 39 BRK=Break no scancode
  255, 255,   3,   4,  19,  20,  17, 199, 200, 201, 202,  39, 202, 255, 255, 255, // DEL=DEL-CHAR INS=INS-CHAR DEL=DEL-LINE INSL=INS-LINE
  //   INS       PUP  DEL,      PWN  LFT, RGT, DWN,  UP,                          // 208 - 224 USB PAGEUP 211 PAGEDOWN 214
  //   INS       DELL DEL,      INSL RGT, LFT, DWN,  UP,                          // ATARI  
  255, 183, 255, 116, 180, 255, 119, 135, 134, 143, 142, 255, 255, 255, 255, 255};// AKEY_RIGHT 0x87 AKEY_LEFT 0x86 AKEY_DOWN 0x8f AKEY_UP 0x8e 
