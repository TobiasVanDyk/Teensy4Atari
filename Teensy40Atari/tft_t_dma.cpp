...
#define DELAY 0x80
    ...
    ST7735_CASET  , 4      ,  //  5: Column addr set, 4 args, no delay:
      0x00, 
      0x00,                   //     XSTART = 0 Normal orientation 240x320 X,Y
      0x00, 
      240,                    //     XEND = 240
...
static void setDmaStruct() {
  uint32_t remaining = TFT_HEIGHT*TFT_WIDTH*2; //320x240 = 76800 x 2 = 153600
  int i=0;
  uint16_t col=RGB16_BLACK; 
